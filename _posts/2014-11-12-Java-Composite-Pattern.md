...
![structure](/media/pattern/composite/structure.png)
...
![windows_directory](/media/pattern/composite/windows_directory.png)
<div align="center">图2 Windows目录结构</div>

图2可以简化为如图3所示树形目录结构：

![directory](/media/pattern/composite/directory.png)
...
![antivirus](/media/pattern/composite/antivirus.png)
...
![transparent_composite](/media/pattern/composite/transparent_composite.png)
...
![safe_composite](/media/pattern/composite/safe_composite.png)
